...
<head>
	...
	<title> Logicando · Cadastrar-se no sistema </title>
...
<body id="topo">
	...
	<section>
		...
		<p class="text_form"> Cadastre-se para ter acesso a vários joguinhos que irão fazer você pensar como um grande programador! </p>
		...
		<section class="form_box">
			...
			<div class="form">
				...
				<form action="" method="post">
					...
					<input type="text" name="name" class="form_input" placeholder="O seu nome" value="<?php echo GetPost('name') ?>" required>
						<div class="form_warning_message">
							<p id="msg_nome">  </p>
						</div>
					<br>

					<input type="text" name="mail" class="form_input" placeholder="O seu e-mail" value="<?php echo GetPost('mail') ?>" required>
						<div class="form_warning_message">
							<p id="msg_mail">  </p>
						</div>
					<br>

					<input type="password" name="password" class="form_input" placeholder="A sua senha" value="<?php echo GetPost('password') ?>" required>
						<div class="form_warning_message">
							<p id="msg_senha">  </p>
						</div>
					<br>

					<input type="password" name="confpass" class="form_input" placeholder="Confirme a sua senha" value="<?php echo GetPost('confpass') ?>" required>
						<div class="form_warning_message">
							<p id="msg_confSenha">  </p>
						</div>
					<br>

					<input type="text" name="idade" class="form_input" placeholder="Quantos anos você tem?" maxlength="2" value="<?php echo GetPost('idade') ?>" required>
						<div class="form_warning_message">
							<p id="msg_nasc">  </p>
						</div>
					<br>

					<input type="text" name="sexo" class="form_input" placeholder="Sexo: M ou F" maxlength="1" value="<?php echo GetPost('sexo') ?>" required>
					<div class="form_warning_message">
						<p id="msg_sexo">  </p>
					</div>
					<br>

					<input type="submit" name="send" value="Cadastrar!" class="form_button">
					
					<input type="reset" value="Limpar Tudo" class="form_button">
