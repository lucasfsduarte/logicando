...
<body id="topo">
	...
	<section class="perfil-screen">
		...
		<div class="div-estatisticas">
			...
			<p class="textOne" style="margin-top: 10px"> Módulo Avançado · Estatísticas </p>

			<center>

				<div class="place-estatistica">
					<div class="grafico" style="height: 100px"></div>
					<p class="textMedalha"> Atividades Concluídas </p>
					<p class="textPontos" style="color: #757ADE"> 2 Atv. </p>
				</div>
		...
		<div class="div-medalhas">
			...
			<center>
				...
				<div class="place-medalha" id="#place-medalha-small">
					...
					<p class="textMedalha"> Veterano da OBI </p>
				...
				<div class="place-medalha" id="#place-medalha-big">
					...
					<p class="textMedalha"> Mestre do Portugol </p>
					<p class="textPontos" style="color: #757ADE"> 2600 pts </p>
				</div>

				<div class="place-medalha" id="#place-medalha-small">
					<div class="medalha-image" id="medalha-prata"></div>
					<p class="textMedalha"> Programador Nato </p>
		...
		<center>
			<a href="finalizando-modulo-3.php">
